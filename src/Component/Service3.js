...
function Service3 () {
    return (
        <div className="serv3">
            ...
            <Icon className="serv3-4" icon="ph:truck" />
            ...
            <div className="serv3-3">
            <Icon className="serv3-4" icon="tabler:plane" />
            <h2>Air Cargo</h2>
            ...
            <div className="serv3-3">
            <Icon className="serv3-4" icon="uil:ship" />
            <h2>Ocean Cargo</h2>
            ...
            <div className="serv3-3">
            <Icon className="serv3-4" icon="emojione-monotone:train" />
            ...
            <div className="serv3-3">
            <Icon className="serv3-4" icon="iconoir:internet" />
            ...
            <div  className="serv3-3">
            <Icon className="serv3-4" icon="game-icons:hand-truck" />
            <h2>Local Moving</h2>
            ...
            <div className="serv3-3">
            <Icon className="serv3-4" icon="carbon:tcp-ip-service" />
            ...
            <div className="serv3-3"> 
            <Icon className="serv3-4" icon="icon-park-outline:import-and-export" />
            <h2>Import & Export</h2>
